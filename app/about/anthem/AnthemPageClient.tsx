...
export default function AnthemPageClient({ page }: any) {
  return (
    <PageTransition>
      <PageHero
        title={page?.title || "School Anthem"}
        subtitle={page?.subtitle || "The song that unites the mighty school"}
        breadcrumbs={[
          { label: "Home", href: "/" },
        ...
        <div className="container-custom max-w-3xl mx-auto">
          ...
          >
            <p className="text-gray-medium dark:text-gray-400 text-sm">
              School Motto: &ldquo;By Reverence, By Questioning, By Service&rdquo;
            </p>
          </motion.div>
        </div>
      </section>
