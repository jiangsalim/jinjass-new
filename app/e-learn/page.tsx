...
export default function ELearnPage() {
  return (
    <>
      <PageHero
        title="E-Learning"
        subtitle="Access digital learning resources and online classes"
        breadcrumbs={[
          { label: "Home", href: "/" },
          { label: "E-Learning" },
        ]}
      ...
      <section className="section-white py-20">
        <div className="container-custom max-w-2xl mx-auto text-center">
          ...
          >
            ...
            <p className="text-charcoal dark:text-gray-300 mb-8">
              Our e-learning portal provides students with access to digital
              learning materials, online assignments, and virtual classrooms.
            </p>
            <a
              href="#"
