...
export default function WritersClubPage() {
  return (
    <>
      <PageHero
        title="Writers Club"
        subtitle="Expressing creativity through the written word"
        breadcrumbs={[
          { label: "Home", href: "/" },
          { label: "Student Clubs", href: "/clubs" },
          { label: "Writers Club" },
        ]}
        bgImage="https://images.unsplash.com/photo-1455390582262-044cdead277a?ixlib=rb-4.0.3&auto=format&fit=crop&w=2070&q=80"
      />
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            >
              ...
              <div className="space-y-4 text-charcoal dark:text-gray-300 leading-relaxed">
                <p>
                  The Writers Club is home to students passionate about creative writing, journalism, poetry, and storytelling. Members contribute to the school magazine, participate in writing competitions, and develop their literary talents.
                </p>
              </div>
            </motion.div>
              ...
              <div className="bg-gray-light dark:bg-navy-light rounded-2xl p-6 mt-4 border border-gray-100 dark:border-navy-light">
                ...
                <ul className="space-y-3 text-sm">
                  <li className="flex justify-between">
                    ...
                    <span className="text-navy dark:text-white font-medium">Thursdays</span>
                  </li>
                  <li className="flex justify-between">
                    <span className="text-gray-medium">Venue</span>
                    <span className="text-navy dark:text-white font-medium">Library</span>
                  </li>
                  <li className="flex justify-between">
