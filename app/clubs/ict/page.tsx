...
export default function ICTClubPage() {
  return (
    <>
      <PageHero
        title="ICT Club"
        subtitle="Building digital skills for the future"
        breadcrumbs={[
          { label: "Home", href: "/" },
          { label: "Student Clubs", href: "/clubs" },
          { label: "ICT Club" },
        ]}
        bgImage="https://images.unsplash.com/photo-1517694712202-14dd9538aa97?ixlib=rb-4.0.3&auto=format&fit=crop&w=2070&q=80"
      />
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            >
              ...
              <div className="space-y-4 text-charcoal dark:text-gray-300 leading-relaxed">
                <p>
                  The ICT Club equips students with essential digital skills including programming, web development, graphic design, and robotics. Members use the state-of-the-art ICT laboratory for hands-on learning.
                </p>
              </div>
            </motion.div>
              ...
              <div className="bg-gray-light dark:bg-navy-light rounded-2xl p-6 mt-4 border border-gray-100 dark:border-navy-light">
                ...
                <ul className="space-y-3 text-sm">
                  <li className="flex justify-between">
                    ...
                    <span className="text-navy dark:text-white font-medium">Wed & Fri</span>
                  </li>
                  <li className="flex justify-between">
                    <span className="text-gray-medium">Venue</span>
                    <span className="text-navy dark:text-white font-medium">ICT Lab</span>
                  </li>
                  <li className="flex justify-between">
