    ...
    <PageTransition>
      ...
      <section className="section-white py-20">
        <div className="container-custom max-w-2xl mx-auto text-center">
          ...
          >
            {/* Icon */}
            <div className="w-24 h-24 bg-teal/10 rounded-3xl flex items-center justify-center mx-auto mb-8">
            ...
            <p className="text-charcoal dark:text-gray-300 text-lg mb-8 max-w-xl mx-auto">
            ...
            <motion.a
              ...
              whileTap={{ scale: 0.97 }}
              className="btn-primary text-lg px-12 py-4 inline-flex items-center gap-3 shadow-xl shadow-teal/25"
            >
            ...
            {/* View Results */}
            <h3 className="font-heading text-2xl font-bold text-navy dark:text-white mb-3">
              View Live Results
            </h3>
