        ...
        <div className="container-custom max-w-2xl mx-auto text-center">
          ...
          >
            ...
            <div className="grid sm:grid-cols-3 gap-6 mb-12">
              {[
                { step: "1", title: "Login", desc: "Use your student credentials to access the portal." },
                { step: "2", title: "View Results", desc: "Access your complete academic results for the current term." },
                { step: "3", title: "Download", desc: "Download and print your official report card as a PDF." },
              ].map((item, index) => (
                <motion.div
                  key={item.step}
            ...
            <p className="text-gray-medium dark:text-gray-400 text-sm mt-6">
              Need help? Contact the ICT Department at{" "}
              <span className="text-teal font-medium">0759669212</span> or email{" "}
              <span className="text-teal font-medium">jinjass1948@gmail.com</span>
            </p>
          </motion.div>
        </div>
      </section>
