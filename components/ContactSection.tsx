      ...
      <div className="container-custom">
        ...
        <div className="grid md:grid-cols-2 gap-10 max-w-6xl mx-auto">
          <motion.div initial={{ opacity: 0, x: -40 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: false, margin: "-100px" }} transition={{ duration: 0.6 }} className="space-y-4">
            ...
            <Link  href="https://jinja-sss-report-card.onrender.com/portal/login/" className="flex items-center justify-center gap-2 bg-teal text-white text-center font-semibold py-4 px-6 rounded-xl hover:bg-teal-dark transition-colors duration-300 shadow-lg">
